...
let params= useParams() //Selected query from category will fetch in this component 
...
const categories= query && query.slice(0,visible).map((item) =>{
    return (
      <Card>
